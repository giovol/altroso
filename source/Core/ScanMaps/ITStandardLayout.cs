...
{
    /// <summary>
    /// Represents the standard Italian keyboard layout.
    /// </summary>
    public class ITStandardLayout : ScanMapBase
    {
        ...
        protected override void InitKeys()
        {
            ...
            Keys.Add(new KeyMapping(0x1A, 'è', 'é', 'è', 'è', 'é', 'é', ConsoleKeyEx.LBracket));
            ...
            /* \ZXCVBNM,./ */
            Keys.Add(new KeyMapping(0x2B, 'ù', '§', 'ù', 'ù', '§', '§', ConsoleKeyEx.Backslash));
            ...
            Keys.Add(new KeyMapping(0x35, '-', '_', '-', '-', '_', '_', ConsoleKeyEx.Slash)); // also numpad divide
            /* Right Shift */
